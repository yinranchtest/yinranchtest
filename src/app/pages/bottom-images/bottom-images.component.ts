...
@Component({
  ...
  templateUrl: './bottom-images.component.html',
  styleUrl: './bottom-images.component.scss'
})
export class BottomImagesComponent implements OnInit, AfterViewInit, OnDestroy {
